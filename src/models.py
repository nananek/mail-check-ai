...
class SmtpRelayConfig(Base):
    ...
    relay_username = Column(String(255), nullable=False, unique=True, comment='リレー接続用ユーザー名')
    relay_password = Column(String(255), nullable=False, comment='リレー接続用パスワード')
    ...
    username = Column(String(255), nullable=False, comment='転送先SMTP認証ユーザー名')
    password = Column(String(255), nullable=False, comment='転送先SMTP認証パスワード')
